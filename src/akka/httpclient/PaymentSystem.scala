...
import akka.httpclient.PaymentSystemDomain.{PaymentAccepted, PaymentRejected, PaymentRequest}
...
object PaymentSystem extends App with PaymentJsonProtocol with SprayJsonSupport {
  ...
  Http().bindAndHandle(paymentRoute, "localhost", 9005)
}
